...
public class GameFlowManager {
    ...
    private void offerTicTacToe() {
        ...
        int choice = JOptionPane.showConfirmDialog(
                colorHuntGame.frame,
                "You've made 3 consecutive wrong attempts! Play Tic Tac Toe to continue?\n" +
        ...
        SwingUtilities.invokeLater(() -> {
            if (playerWon) {
                ...
                try {
                    ...
                    Color resumedColor = newMc.getColor();
                    if (resumedColor.equals(Color.BLACK)) {
                        colorHuntGame.getColorLabel().setForeground(Color.LIGHT_GRAY);
                    } else {
                        colorHuntGame.getColorLabel().setForeground(resumedColor);
                    }
