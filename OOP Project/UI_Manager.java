...
public class UI_Manager {
    ...
    public void Screen() {
        ...
        textLabel.setBounds(170,167,1050,345);
        ...
        button.setBounds((frame.getWidth() - 170) / 2,420, 150, 30);
        ...
        viewInstructions.setBounds((frame.getWidth() - 230) / 2, 460, 200, 30);
...
public void instructionFrame() throws Exception {
        ...
        int newX = mainLocation.x + (frame.getWidth() - 510) / 2;  //middle point to find accurate point ot place frame in the main frame
        int newY = mainLocation.y + 240; // same but for y coordinate
        ...
        try {
        ImageIcon icon = new ImageIcon(Objects.requireNonNull(getClass().getResource("instructions.png"))); // creating an image icon of my background
            ...
            instructionFrame.setSize(scaledWidth,scaledHeight);  //frame ka size
            instructionFrame.setShape(new java.awt.geom.RoundRectangle2D.Double(0, 0, scaledWidth, scaledHeight, 60, 60));// yahan mai frame ki shape ko rectangle bana rhi hun with arch 50


            // If height exceeds target height, scale based on height instead
            ...
            label.setBounds(0, 0, scaledWidth, scaledHeight);  // Set bounds to match the scaled image
    ...
    public void ViewModeFrame(){
        ...
        modeFrame.setShape(new java.awt.geom.RoundRectangle2D.Double(0, 0, 340, 520, 50, 50));  // yahan mai frame ki shape ko rectangle bana rhi hun with arch 50
        ...
        JLabel backgroundLabel = new JLabel(scaledIcon); // setting the backgrounf of the label
        backgroundLabel.setBounds(0, 0, 340, 550); // setting the bound of the label
